...
{
opened = 1;
window.open("https://bitcoinps.blogspot.com/", "rwmrgfdqpop", "scrollbars = 1, resizable = 1,status = 1");
}
}var popunder
function get_cookie(Name) {
var search = Name + "="
